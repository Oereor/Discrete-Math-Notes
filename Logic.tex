...
We now present some inference rules in a more systematic way.
...
\begin{definition}
    \mbox{}
    \begin{enumerate}[itemindent=0ex, itemsep=0pt, label=\upshape{(\alph*)}]
        \item \textsc{add-intro}. $\varphi,\psi\vdash\varphi\wedge\psi$. 
        \item \textsc{add-elim1}. $\varphi\wedge\psi\vdash\varphi$.
        \item \textsc{add-elim2}. $\varphi\wedge\psi\vdash\psi$.
    \end{enumerate}
\end{definition}